      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
          ...
          >
            ...
            <h3 className="font-display font-semibold mb-1 sm:mb-2 text-sm sm:text-base">{t("contact.email")}</h3>
          ...
          <div className="glass-card p-4 sm:p-6">
            ...
            <h3 className="font-display font-semibold mb-1 sm:mb-2 text-sm sm:text-base">{t("contact.location")}</h3>
